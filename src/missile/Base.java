...
//    Missile missile;
    ...
    public static void init() {
        ...
        int i = 0;
        while (iter.isRoom())
            iter.store(new Base(i++));
    }

    /**
     * Prepares for a new game or level
     * @param type one of {GAME, LEVEL}
     */
    public static void prepare(int type) {}

    private static int destroyIndex;
...
//        if (BEngine.getLayer() != BEngine.L_BGND) return;
    ...
    public static int getActiveCount(int type) {
...
//    }
    ...
    protected void clearBgnd() {//Graphics g) {
//        if (true) return;
        //BomberObj h= null;
